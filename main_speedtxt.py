...
while cap1.isOpened():
    ...
    if success1:
        ...
        print(
            f'Speed: {velocity} kmh || Lane_state: {output_obj[3]} || Driver state: {driv_state} || Sign: {sign_name}')
        print(
            f'Object: {output_obj[0]} || Distance: {objDetector.closestObjectInfo[-2]} m || Time Collision: {output_obj[1]} s || Collision State: {output_obj[2]}')
