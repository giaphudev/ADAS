...
def videoWriter(shape, video_name='video_output', output_dir='output_video', fps=5000):
...
# class SQLConnector:
#     def __init__(self, host=('localhost'), user=('giaphu'), password=('123'), database=('assistance_car')):
#         self.host = host
#         self.user = user
